...
namespace Prototype.NetworkLobby
{
    public class LobbyManager : NetworkLobbyManager 
    {
        ...
        public Button backButton, singleButton;// atrasButton;
...
//            backDelegate = StopClientClbk;
        ...
        void Start()
        {
            ...
            singleButton.onClick.AddListener(GoSingleGame);
            ///////
           // atrasButton.onClick.AddListener(GoMenuActividades);
            //////
        }
